...
void gemm_4bit_inference_naive_fp16(int m, int n, int k, half * A,  unsigned char* B,  float *delta, float *min_val, float *datatype, half * out,  int lda, int ldb, int ldc, int blocksize)
{ gemm_4bit_inference_naive<half, 16>(m, n, k, A, B, delta, min_val,  datatype, out, lda, ldb, ldc, blocksize); }

void gemm_4bit_inference_naive_bf16(int m, int n, int k, __nv_bfloat16 * A,  unsigned char* B,  float *delta, float *min_val, float *datatype, __nv_bfloat16 * out,  int lda, int ldb, int ldc, int blocksize)
{ gemm_4bit_inference_naive<__nv_bfloat16, 16>(m, n, k, A, B, delta, min_val,  datatype, out, lda, ldb, ldc, blocksize); }

void gemm_4bit_inference_naive_fp32(int m, int n, int k, float * A,  unsigned char* B,  float *delta, float *min_val, float *datatype, float * out,  int lda, int ldb, int ldc, int blocksize)
{ gemm_4bit_inference_naive<float, 32>(m, n, k, A, B, delta, min_val,  datatype, out, lda, ldb, ldc, blocksize); }
...
void quantizeBlockwiseInt4_fp16(float * code, half *A, float *delta, float *min_val, unsigned char *out, int blocksize, const int n) {quantizeBlockwiseInt4<half>(code, A, delta, min_val, out, NULL, 0, blocksize, n);}
...
void quantizeBlockwiseInt4_bf16(float * code, __nv_bfloat16 *A, float *delta, float *min_val, unsigned char *out, int blocksize, const int n) {quantizeBlockwiseInt4<__nv_bfloat16>(code, A, delta, min_val, out, NULL, 0, blocksize, n);}
...
void quantizeBlockwiseInt4_fp32(float * code, float *A, float *delta, float *min_val, unsigned char *out, int blocksize, const int n) {quantizeBlockwiseInt4<float>(code, A, delta, min_val, out, NULL, 0, blocksize, n);}
...
extern "C"
{
  ...
  void cdequantize_blockwise_fp16_int4(float * code, unsigned char *A, float *delta, float *min_val, half *out, int blocksize, const int n) { dequantizeBlockwiseInt4_fp16(code, A, delta, min_val, out, blocksize, n); }
  ...
  void cquantize_blockwise_fp16_int4(float * code, half *A, float *delta, float *min_val, unsigned char *out, int blocksize, const int n) { quantizeBlockwiseInt4_fp16(code, A, delta, min_val, out, blocksize, n); }
  ...
  void cquantize_blockwise_fp32_int4(float * code, float *A, float *delta, float *min_val, unsigned char *out, int blocksize, const int n) { quantizeBlockwiseInt4_fp32(code, A, delta, min_val, out, blocksize, n); }
  ...
  void cdequantize_blockwise_fp32_int4(float * code, unsigned char *A, float *delta, float *min_val, float *out, int blocksize, const int n) { dequantizeBlockwiseInt4_fp32(code, A, delta, min_val, out, blocksize, n); }
  ...
  void cquantize_blockwise_bf16_int4(float * code, __nv_bfloat16 *A, float *delta, float *min_val, unsigned char *out, int blocksize, const int n) { quantizeBlockwiseInt4_bf16(code, A, delta, min_val, out, blocksize, n); }
  ...
  void cdequantize_blockwise_bf16_int4(float * code, unsigned char *A, float *delta, float *min_val, __nv_bfloat16 *out, int blocksize, const int n) { dequantizeBlockwiseInt4_bf16(code, A, delta, min_val, out, blocksize, n); }
  ...
  #define CMAKE_ELEMENTWISE_FUNC(fname, type_name, ctype, FUNC) \
	...
	void cgemm_4bit_inference_naive_fp16(int m, int n, int k, half * A,  unsigned char* B,  float *delta, float *min_val, float *datatype, half * out,  int lda, int ldb, int ldc, int blocksize)
	{ gemm_4bit_inference_naive_fp16(m, n, k, A, B, delta, min_val,  datatype, out, lda, ldb, ldc, blocksize); }

	void cgemm_4bit_inference_naive_bf16(int m, int n, int k, __nv_bfloat16 * A,  unsigned char* B,  float *delta, float *min_val, float *datatype, __nv_bfloat16 * out,  int lda, int ldb, int ldc, int blocksize)
	{ gemm_4bit_inference_naive_bf16(m, n, k, A, B, delta, min_val,  datatype, out, lda, ldb, ldc, blocksize); }

	void cgemm_4bit_inference_naive_fp32(int m, int n, int k, float * A,  unsigned char* B, float *delta, float *min_val, float *datatype, float * out,  int lda, int ldb, int ldc, int blocksize)
	{ gemm_4bit_inference_naive_fp32(m, n, k, A, B, delta, min_val, datatype, out, lda, ldb, ldc, blocksize); }
